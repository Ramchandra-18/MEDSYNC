    ...
    <footer className="bg-gray-900 border-t border-sky-300 py-12 px-8 text-white font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
         ...
         <li> <Link to="/patient/appointments" className="text-black hover:text-blue-600 transition px-2 py-1 rounded">
          Appointments
        </Link></li>
       <li> <Link to="/patient/doctors" className="text-black hover:text-blue-600 transition px-2 py-1 rounded">
         Our Doctors
        </Link></li>
       <li> <Link to="/patient/profile" className="text-black hover:text-blue-600 transition px-2 py-1 rounded">
          Profile
        </Link></li>
          </ul>
        </div>
